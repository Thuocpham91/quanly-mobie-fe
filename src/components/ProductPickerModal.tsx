                    ...
                    <button 
                      ...
                      onClick={() => {
                        if (selectedProductId === p.id) {
                          // Calculate total pieces for submission
                          ...
                          onSelect(p, {
                            ...
                            // For backward compatibility with the table display if needed
                            conversionFactor: 1, 
                            quantityBoxes: 0 
                          });
                          ...
                          setDetails({
                            ...details,
                            baseUnitId: p.unitId || '',
                            unitQuantities: {}, // Reset quantities
                            costPrice: 0,
                            expiryDate: ''
                          });
                        }
                        ...
                        <div>
                          ...
                          <input 
                            ...
                            onChange={(e) => setDetails({
                              ...details, 
                              unitQuantities: { ...details.unitQuantities, [p.unitId || '']: parseFloat(e.target.value) || 0 }
                            })}
                          />
                        </div>
